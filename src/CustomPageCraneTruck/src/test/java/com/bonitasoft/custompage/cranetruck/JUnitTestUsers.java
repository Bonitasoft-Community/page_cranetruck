...
public class JUnitTestUsers {
    ...
    static Logger logger = Logger.getLogger(JUnitTestUsers.class.getName());
    ...
    public void getUsers() {
        ...
        final StatusOperation statusOperation = userOperations.getUsersList(identityAPI);
        System.out.println("ResultGetuserList:" + statusOperation.mStatusResultJson);
