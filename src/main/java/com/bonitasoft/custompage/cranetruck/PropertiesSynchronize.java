...
public class PropertiesSynchronize implements PropertiesParam {
    ...
    public static StatusOperation checkSynchronize(final PropertiesSynchronizeTest propertiesSynchronizeTest) {
        ...
        try {
            ...
            statusOperation.addAdditionalInfo("watchdirectories", testWathDirectories);
            // LDAP SEARCH USER
            ...
            if (e instanceof ClassNotFoundException) {
                logger.severe("LdapConnection: ClassNotFoundException" + e.toString() + " detail: " + sw.toString());

                synthesis
                        .append("To execute this function, you must copy the bonita-ldap-synchronizer.jar file from the LDAP Synchronizer too in the bonita/WEB-INF/lib path");
                statusOperation.mStatusError = "To execute this function, you must copy the bonita-ldap-synchronizer.jar file from the LDAP Synchronizer too in the bonita/WEB-INF/lib path";
        ...
        statusOperation.addAdditionalInfo("synthesis", synthesis.toString());
