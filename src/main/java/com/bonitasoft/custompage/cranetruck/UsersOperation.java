...
public class UsersOperation {
    ...
    public StatusOperation getUsersList(final IdentityAPI identityApi) {
        ...
        try {
            statusOperation.addAdditionalInfo("totalusers", identityApi.getNumberOfUsers());
            ...
            statusOperation.addAdditionalInfo("list", listUsers);
    ...
    public StatusOperation doOperation(final IdentityAPI identityApi, final long myself) {
        ...
        try {
            ...
            statusOperation.addAdditionalInfo("status", statusSuccess);
        ...
        statusOperation.addStatusOperation(StatusOperationList);
